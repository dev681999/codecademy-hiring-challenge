...
func (cq *CatQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cq *CatQuery) FirstIDX(ctx context.Context) string {
...
func (cq *CatQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cq *CatQuery) OnlyIDX(ctx context.Context) string {
...
func (cq *CatQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
...
func (cq *CatQuery) IDsX(ctx context.Context) []string {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.Cat.Query().
//		GroupBy(cat.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
func (cq *CatQuery) GroupBy(field string, fields ...string) *CatGroupBy {
	grbuild := &CatGroupBy{config: cq.config}
...
//
//	client.Cat.Query().
//		Select(cat.FieldCreateTime).
//		Scan(ctx, &v)
//
func (cq *CatQuery) Select(fields ...string) *CatSelect {
	cq.fields = append(cq.fields, fields...)
	selbuild := &CatSelect{CatQuery: cq}
	selbuild.label = cat.Label
...
func (cq *CatQuery) Modify(modifiers ...func(s *sql.Selector)) *CatSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (cs *CatSelect) Modify(modifiers ...func(s *sql.Selector)) *CatSelect {
